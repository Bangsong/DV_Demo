layui.config({
    base: 'content/WinUI/lib/winui/' //指定 winui 路径
    , version: '1.0.0-beta'
}).extend({  //指定js别名
    ...
    $(function () {
        ...
        winui.config({
            settings: layui.data('winui').settings || {
                ...
                taskbarMode: 'bottom',
                startSize: 'sm',
                bgSrc: 'content/WinUI/images/bg_01.jpg',
                lockBgSrc: 'content/WinUI/images/bg_04.jpg'
            },  //如果本地配置为空则给默认值
            desktop: {
            ...
            menu: {
                options: {
                    url: 'content/WinUI/json/allmenu.json',
                    method: 'get',
                    data: { nihaoa: '' }
                },
